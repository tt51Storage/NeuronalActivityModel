...
r_1=1*(1/mean(Noutputs)); % coefficient of  decrease due to transmission of exitation, U1
r_2=1*(1/mean(sum(Gr.*Gr,1)));     % coefficient of  decrease due to over-exitation, U2

eps=0.003; % coefficient for energy increase
Grq=zeros(n,n);
%load My_net1 
