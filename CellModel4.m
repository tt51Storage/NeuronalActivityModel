...
clear all
global Act E E_up eps Noutputs Ninputs r_1 r_2 Tk Net param;
...
for r1_0=1.0:0.1:1.3
    for r2_0=4.5:0.5:6.0
        clear Act E Grq;
        Act=zeros(n,Tk);
        E=zeros(n,Tk);
        E(:,1)=0.5*E_lo.*rand(n,1);
        
        r_1=r1_0*(1/mean(Noutputs)); % coefficient of  decrease due to transmission of exitation, U1
        r_2=r2_0*(1/mean(sum(Gr.*Gr,1)));     % coefficient of  decrease due to over-exitation, U2
